...
class ImageUpscaler:
    ...
    def upscale_image(
        ...
        Args:
            low_res_image (Image.Image): The low-resolution input image or its filename.
    ...
    def upscale_and_save(
        ...
        Args:
            low_res_image (Image.Image | str): The low-resolution input image or its filename.
